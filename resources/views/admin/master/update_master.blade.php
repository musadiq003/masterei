...
<main>
	<div class="container-fluid">
		...
		<div class="card mb-4">
			...
			<div class="card-body">
				<form method="post" action="{{url('/update/master/'.$master->id)}}" enctype="multipart/form-data">
					{{csrf_field()}}
					<div class="container">
						<div class="col-md-6">
					...
					<div class="col">
						<input value="{{$master->text1}}" name="text1" type="text" class="form-control" placeholder="Enter title">
						<input value="{{$master->text2}}" name="text2" type="text" class="form-control" placeholder="Enter title">
					</div>
					<div class="col-md-6">
